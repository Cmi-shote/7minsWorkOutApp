...
import com.example.a7minsworkoutapp.databinding.ActivityExerciseBinding
import com.example.a7minsworkoutapp.databinding.CustomDialogBinding
import java.util.*
...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private fun setupRestView(){
        ...
        try{
            val soundURI = Uri.parse(
                "android.resources://com.example.a7minsworkoutapp/" + R.raw.press_start)
    ...
    private fun setRestProgressBar(){
        ...
        //to create a new object, use the object keyword
        restTimer = object: CountDownTimer(restTimerDuration*10000, 1000){
            ...
            override fun onFinish() {
                ...
                //notifyDataSetChanged calls the on bind and on create view holder in the adapter
                setupExerciseView()
            }
        }.start()
    }
